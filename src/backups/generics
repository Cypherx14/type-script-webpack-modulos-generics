...
import {Hero, Villain} from '../interfaces'; //importando interfaces
...
console.log(genericFunctionArrow<Hero>(deadpool).realName); // Esto funcionará porque realName es una propiedad de Hero

// console.log(genericFunctionArrow<Hero>(deadpool).dangerLevel); // Esto no funcionará porque dangerLevel no es una propiedad de Hero


console.log(genericFunctionArrow<Villain>(deadpool).dangerLevel); // Esto funcionará porque dangerLevel es una propiedad de Villain
